...
class SimpleImageViewer(object):
    ...
    def draw_circle(
        self, radius=10, res=30, pos_x=0, pos_y=0, color=(1.0, 1.0, 1.0, 1.0), **attrs
    ):
    ...
    def saveGif(self, filename=None, arr=None, duration=0):
        arr[0].save(
            filename, save_all=True, append_images=arr[1:], duration=500, quality=95
